...
public class Organization extends TableImpl<OrganizationRecord> {
     ...
     */
    public final TableField<OrganizationRecord, Integer> INN = createField(DSL.name("inn"), SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>public.organization.name</code>.
     */
    public final TableField<OrganizationRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>public.organization.bank_account</code>.
     */
    public final TableField<OrganizationRecord, String> BANK_ACCOUNT = createField(DSL.name("bank_account"), SQLDataType.VARCHAR, this, "");
